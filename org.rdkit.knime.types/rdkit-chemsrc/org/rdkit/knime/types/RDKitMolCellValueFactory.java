...
public class RDKitMolCellValueFactory implements ValueFactory<VarBinaryReadAccess, VarBinaryWriteAccess> { // NOSONAR: cannot be removed
    ...
    private static final class RDKitMolCellReadValue implements ReadValue {
